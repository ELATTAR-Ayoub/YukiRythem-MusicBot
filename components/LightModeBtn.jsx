...
const LightModeBtn = () => {
  ...
  return (
    ...
    <button onClick={() => toggleTheme()} className='grid content-center transition-all duration-300 hover:bg-primary-color-53 dark:hover:bg-primary-color-83 rounded-full p-3' aria-label="toggle_light_mode">
        { 
        (theme !== 'dark') ? 
